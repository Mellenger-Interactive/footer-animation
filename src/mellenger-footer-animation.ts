...
class MellengerFooterAnimation extends HTMLElement {
  ...
  init() {
    ...
    // const footerAnimation = () => {
      ...
      const bottomWall = Bodies.rectangle(canvasWidth / 2, canvasHeight, canvasWidth * 2, 2, {
        isStatic: true,
        render: {
          fillStyle: 'white',
          strokeStyle: 'white'
      ...
      const rightWall = Bodies.rectangle(canvasWidth, canvasHeight / 2, 2, canvasHeight * 2, {
        isStatic: true,
        render: {
          fillStyle: 'white',
          strokeStyle: 'white'
